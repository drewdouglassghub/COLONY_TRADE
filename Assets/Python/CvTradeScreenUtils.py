...
import RefreshRouter as RefreshRouter
import Assets.Python.TradeYieldRegistry as TradeYieldRegistry
import Assets.Python.TradePlayerRegistry as TradePlayerRegistry
import CvScreenUtils

class TradeScreenUtils:
    ...
    def update(self, argsList):
        ...
        RefreshRouter.checkAndRoute(self, screenEnum)
